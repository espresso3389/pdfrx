...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AJ: x0 => x0.removeAllRanges(),
      AK: (x0,x1) => { x0.src = x1 },
      AL: (x0,x1) => x0.readEntries(x1),
      ...
      BJ: (x0,x1) => x0.addRange(x1),
      BK: (x0,x1) => { x0.async = x1 },
      BL: x0 => x0.isDirectory,
      ...
      HJ: x0 => x0.classList,
      HK: x0 => { globalThis.pdfiumWasmWorkerUrl = x0 },
      HL: x0 => x0.getReader(),
      ...
      QI: () => new FileReader(),
      QJ: x0 => globalThis.URL.revokeObjectURL(x0),
      QK: x0 => x0.code,
      ...
      XJ: (x0,x1,x2) => x0.insertBefore(x1,x2),
      XK: x0 => x0.lastModified,
      Y: (o0, o1) => [o0, o1],
      ...
      kI: (x0,x1,x2,x3) => x0.sendCommand(x1,x2,x3),
      ...
      lI: () => globalThis.PdfiumWasmCommunicator,
      lJ: (x0,x1) => { x0.height = x1 },
      lK: (x0,x1) => { x0.ondragleave = x1 },
      m: () => globalThis.Math,
      ...
      rG: x0 => x0.state,
      rH: (x0,x1) => x0.lock(x1),
      rI: (x0,x1) => x0.append(x1),
      rJ: x0 => x0.imageBitmaps,
      rK: x0 => x0.webkitGetAsEntry(),
      s: () => ({}),
      sB: o => {
        if (o === null || o === undefined) return 0;
      ...
      sI: (x0,x1,x2) => x0.insertRule(x1,x2),
      sJ: x0 => x0.canvasKitMaximumSurfaces,
      sK: x0 => x0.createReader(),
      t: (o, p, v) => o[p] = v,
      ...
      uK: (x0,x1,x2,x3) => x0.slice(x1,x2,x3),
      v: (a, i) => a.push(i),
      ...
      vI: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      xG: x0 => x0.maxWidth,
      xH: x0 => x0.document,
      xI: x0 => x0.createRange(),
      xJ: x0 => x0.preventDefault(),
      xK: x0 => x0.fullPath,
