...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1195: x0 => x0.length,
      _1257: (x0,x1) => x0.registerCallback(x1),
      _1258: (x0,x1) => x0.unregisterCallback(x1),
      _1259: (x0,x1) => x0.createElement(x1),
      _1260: (x0,x1) => x0.querySelector(x1),
      _1261: (x0,x1) => x0.appendChild(x1),
      _1262: x0 => ({type: x0}),
      _1263: (x0,x1) => new Blob(x0,x1),
      _1264: x0 => globalThis.URL.createObjectURL(x0),
      _1265: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1265(f,arguments.length,x0,x1) }),
      _1267: () => globalThis.PdfiumWasmCommunicator,
      _1268: (x0,x1,x2) => x0.sendCommand(x1,x2),
      _1270: x0 => globalThis.pdfiumWasmWorkerUrl = x0,
      _1271: (x0,x1) => x0.writeText(x1),
      _1272: x0 => x0.preventDefault(),
      _1273: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1273(f,arguments.length,x0) }),
      _1274: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1275: x0 => x0.createRange(),
      _1276: (x0,x1) => x0.selectNode(x1),
      _1277: x0 => x0.getSelection(),
      _1278: x0 => x0.removeAllRanges(),
      _1279: (x0,x1) => x0.addRange(x1),
      _1280: (x0,x1) => x0.createElement(x1),
      _1281: (x0,x1) => x0.append(x1),
      _1282: (x0,x1,x2) => x0.insertRule(x1,x2),
      _1283: (x0,x1) => x0.add(x1),
      ...
      _1286: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1287: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      ...
      _2942: (x0,x1) => x0.src = x1,
      _2944: (x0,x1) => x0.type = x1,
      _2948: (x0,x1) => x0.async = x1,
      _2962: (x0,x1) => x0.charset = x1,
      _3411: () => globalThis.window,
      _3454: x0 => x0.location,
      _3473: x0 => x0.navigator,
      _3745: x0 => x0.href,
      _3796: x0 => x0.message,
      _3841: x0 => x0.clipboard,
      _3862: x0 => x0.userAgent,
      _3863: x0 => x0.vendor,
      _5976: x0 => x0.type,
      _6089: () => globalThis.document,
      _8032: x0 => x0.size,
      _8040: x0 => x0.name,
      _8041: x0 => x0.lastModified,
      _8046: x0 => x0.length,
      _8052: x0 => x0.result,
...
"direction",
"skipCount",
"Cannot modify the length of an unmodifiable list",
"\\r?\\n",
": Internal Error: text and character rects length mismatch (",
" <=> ",
"loadTextCharRects",
"charRects",
"loadText",
...
"pdfrx: Context menu event prevented because PdfViewer has focus.",
"pdfrx: Context menu event allowed.",
"No temporary directory available for web.",
...
"PdfDocumentFactory.instance is not initialized. Please call pdfrxInitialize()/pdfrxFlutterInitialize() or explicitly set PdfDocumentFactory.instance.",
"firstPageIndex",
"loadUnitDuration",
