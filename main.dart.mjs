...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1634: () => globalThis.pdfjsLib,
      _1635: x0 => globalThis.pdfjsLib.getDocument(x0),
      _1646: x0 => globalThis.pdfjsLib.GlobalWorkerOptions.workerSrc = x0,
      _1647: x0 => x0.promise,
      _1648: (x0,x1,x2,x3,x4,x5,x6,x7) => ({url: x0,httpHeaders: x1,withCredentials: x2,password: x3,cMapUrl: x4,cMapPacked: x5,useSystemFonts: x6,standardFontDataUrl: x7}),
      _1649: (x0,x1,x2,x3,x4,x5) => ({data: x0,password: x1,cMapUrl: x2,cMapPacked: x3,useSystemFonts: x4,standardFontDataUrl: x5}),
      _1650: (x0,x1) => x0.getPage(x1),
      _1651: x0 => x0.getPermissions(),
      _1652: x0 => x0.numPages,
      _1653: x0 => x0.destroy(),
      _1654: (x0,x1) => x0.getPageIndex(x1),
      _1655: (x0,x1) => x0.getDestination(x1),
      _1656: x0 => x0.getOutline(),
      _1657: (x0,x1) => x0.getViewport(x1),
      _1658: (x0,x1) => x0.render(x1),
      _1660: x0 => x0.rotate,
      _1663: (x0,x1) => x0.getTextContent(x1),
      _1667: (x0,x1) => x0.getAnnotations(x1),
      _1668: x0 => x0.subtype,
      _1670: x0 => x0.rect,
      _1671: x0 => x0.url,
      _1674: x0 => x0.dest,
      ...
      _1700: x0 => x0.height,
      _1723: x0 => x0.promise,
      _1724: (x0,x1) => ({includeMarkedContent: x0,disableNormalization: x1}),
      _1729: x0 => x0.items,
      _1731: x0 => x0.str,
      _1733: x0 => x0.transform,
      _1734: x0 => x0.width,
      _1735: x0 => x0.height,
      _1737: x0 => x0.hasEOL,
      _1760: x0 => x0.title,
      _1761: x0 => x0.dest,
      _1762: x0 => x0.items,
      _1763: (x0,x1) => x0.querySelector(x1),
      _1764: (x0,x1) => x0.appendChild(x1),
      _1772: x0 => ({scale: x0}),
      _1773: (x0,x1,x2,x3) => ({scale: x0,offsetX: x1,offsetY: x2,dontFlip: x3}),
      _1774: (x0,x1,x2,x3,x4) => x0.fillRect(x1,x2,x3,x4),
      _1775: (x0,x1,x2) => ({canvasContext: x0,viewport: x1,annotationMode: x2}),
      _1776: (x0,x1,x2,x3,x4) => x0.getImageData(x1,x2,x3,x4),
      _1777: () => ({}),
      ...
      _1795: (x0,x1) => x0.querySelector(x1),
      _1796: (x0,x1) => x0.appendChild(x1),
      _1797: (x0,x1) => x0.appendChild(x1),
      _1798: (x0,x1) => x0.item(x1),
      _1799: x0 => x0.remove(),
      _1800: x0 => x0.remove(),
      _1801: x0 => x0.remove(),
      _1802: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1802(f,arguments.length,x0) }),
      _1803: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1804: x0 => x0.click(),
      _1805: x0 => globalThis.URL.createObjectURL(x0),
      _1816: x0 => new Array(x0),
      _1818: x0 => x0.length,
      _1820: (x0,x1) => x0[x1],
      _1821: (x0,x1,x2) => x0[x1] = x2,
      _1824: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1826: x0 => new Int8Array(x0),
      _1827: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1828: x0 => new Uint8Array(x0),
      _1836: x0 => new Int32Array(x0),
      _1840: x0 => new Float32Array(x0),
      _1842: x0 => new Float64Array(x0),
      _1843: (o, t) => typeof o === t,
      _1844: (o, c) => o instanceof c,
      ...
      _1874: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1875: () => new TextDecoder("utf-8", {fatal: true}),
      _1876: () => new TextDecoder("utf-8", {fatal: false}),
      _1877: x0 => new WeakRef(x0),
      _1878: x0 => x0.deref(),
      _1884: Date.now,
      _1886: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1887: s => {
      ...
      _1889: () => typeof dartUseDateNowForTicks !== "undefined",
      _1890: () => 1000 * performance.now(),
      _1891: () => Date.now(),
      _1894: () => new WeakMap(),
      _1895: (map, o) => map.get(o),
      _1896: (map, o, v) => map.set(o, v),
      _1897: () => globalThis.WeakRef,
      _1908: s => JSON.stringify(s),
      _1909: s => printToConsole(s),
      _1910: a => a.join(''),
      _1913: (s, t) => s.split(t),
      _1914: s => s.toLowerCase(),
      _1915: s => s.toUpperCase(),
      _1916: s => s.trim(),
      _1917: s => s.trimLeft(),
      _1918: s => s.trimRight(),
      _1920: (s, p, i) => s.indexOf(p, i),
      _1921: (s, p, i) => s.lastIndexOf(p, i),
      _1923: Object.is,
      _1924: s => s.toUpperCase(),
      _1925: s => s.toLowerCase(),
      _1926: (a, i) => a.push(i),
      _1929: (a, l) => a.length = l,
      _1930: a => a.pop(),
      _1931: (a, i) => a.splice(i, 1),
      _1933: (a, s) => a.join(s),
      _1934: (a, s, e) => a.slice(s, e),
      _1937: a => a.length,
      _1938: (a, l) => a.length = l,
      _1939: (a, i) => a[i],
      _1940: (a, i, v) => a[i] = v,
      _1942: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1943: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1944: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1945: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1946: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1947: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      ...
      _1952: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1953: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1954: (t, s) => t.set(s),
      _1956: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1957: o => o.byteLength,
      _1958: o => o.buffer,
      _1959: o => o.byteOffset,
      _1960: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1961: (b, o) => new DataView(b, o),
      _1962: (b, o, l) => new DataView(b, o, l),
      _1963: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1964: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1965: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1966: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1967: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1968: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1969: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1970: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1971: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1972: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1973: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1974: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1977: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1978: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1979: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1980: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1981: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1982: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1995: (o, t) => o instanceof t,
      ...
      _1999: o => Object.keys(o),
      _2000: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _2001: (handle) => clearTimeout(handle),
      _2002: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _2003: (handle) => clearInterval(handle),
      _2004: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _2005: () => Date.now(),
      _2019: () => new XMLHttpRequest(),
      _2020: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _2021: x0 => x0.send(),
      _2023: () => new FileReader(),
      _2024: (x0,x1) => x0.readAsArrayBuffer(x1),
      _2033: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2033(f,arguments.length,x0) }),
      _2034: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2034(f,arguments.length,x0) }),
      _2049: (x0,x1) => x0.getContext(x1),
      _2059: (s, m) => {
        try {
      ...
      _2060: (x0,x1) => x0.exec(x1),
      _2061: (x0,x1) => x0.test(x1),
      _2062: (x0,x1) => x0.exec(x1),
      ...
      _2099: l => arrayFromDartList(Int8Array, l),
      _2100: l => arrayFromDartList(Uint8Array, l),
      _2101: l => arrayFromDartList(Uint8ClampedArray, l),
      _2102: l => arrayFromDartList(Int16Array, l),
      _2103: l => arrayFromDartList(Uint16Array, l),
      _2104: l => arrayFromDartList(Int32Array, l),
      _2105: l => arrayFromDartList(Uint32Array, l),
      _2106: l => arrayFromDartList(Float32Array, l),
      _2107: l => arrayFromDartList(Float64Array, l),
      ...
      _2110: l => arrayFromDartList(Array, l),
      _2111: () => ({}),
      _2112: () => [],
      _2113: l => new Array(l),
      _2114: () => globalThis,
      _2115: (constructor, args) => {
      ...
      _2117: (o, p) => o[p],
      _2118: (o, p, v) => o[p] = v,
      _2119: (o, m, a) => o[m].apply(o, a),
      _2121: o => String(o),
      _2122: (p, s, f) => p.then(s, f),
      _2123: o => {
      ...
      _2137: x0 => x0.index,
      _2140: (x0,x1) => x0.exec(x1),
      _2142: x0 => x0.flags,
      _2143: x0 => x0.multiline,
      _2144: x0 => x0.ignoreCase,
      _2145: x0 => x0.unicode,
      _2146: x0 => x0.dotAll,
      _2147: (x0,x1) => x0.lastIndex = x1,
      _2148: (o, p) => p in o,
      _2149: (o, p) => o[p],
      _2152: x0 => x0.random(),
      _2153: x0 => x0.random(),
      _2157: () => globalThis.Math,
      _2159: Function.prototype.call.bind(Number.prototype.toString),
      _2160: (d, digits) => d.toFixed(digits),
      _2164: () => globalThis.document,
      _2165: () => globalThis.window,
      _2170: (x0,x1) => x0.height = x1,
      _2172: (x0,x1) => x0.width = x1,
      _2176: x0 => x0.head,
      _2179: x0 => x0.classList,
      _2184: (x0,x1) => x0.innerText = x1,
      _2185: x0 => x0.style,
      _2187: x0 => x0.sheet,
      _2199: x0 => x0.offsetX,
      _2200: x0 => x0.offsetY,
      ...
      _2611: x0 => x0.content,
      _3290: (x0,x1) => x0.accept = x1,
      _3304: x0 => x0.files,
      _3330: (x0,x1) => x0.multiple = x1,
      _3348: (x0,x1) => x0.type = x1,
      _3603: (x0,x1) => x0.src = x1,
      _3605: (x0,x1) => x0.type = x1,
      _3609: (x0,x1) => x0.async = x1,
      _3623: (x0,x1) => x0.charset = x1,
      _3650: (x0,x1) => x0.width = x1,
      _3652: (x0,x1) => x0.height = x1,
      _3723: (x0,x1) => x0.fillStyle = x1,
      _3784: x0 => x0.data,
      _4090: () => globalThis.window,
      _4135: x0 => x0.location,
      _4154: x0 => x0.navigator,
      _4426: x0 => x0.href,
      _4478: x0 => x0.message,
      _4545: x0 => x0.userAgent,
      _4546: x0 => x0.vendor,
      _6749: x0 => x0.type,
      _6871: () => globalThis.document,
      _8884: x0 => x0.size,
      _8892: x0 => x0.name,
      _8893: x0 => x0.lastModified,
      _8899: x0 => x0.length,
      _8910: x0 => x0.result,
