...
/// Return value:
/// None.
@ffi.Native<ffi.Void Function(FPDF_DWORD, FPDF_BOOL)>()
external void FPDF_SetSandBoxPolicy(int policy, int enable);
...
@ffi.Native<
  FPDF_DOCUMENT Function(ffi.Pointer<ffi.Void>, ffi.Int, FPDF_BYTESTRING)
>()
external FPDF_DOCUMENT FPDF_LoadMemDocument(
...
>()
external FPDF_DOCUMENT FPDF_LoadCustomDocument(
...
@ffi.Native<FPDF_BOOL Function(FPDF_DOCUMENT, ffi.Pointer<ffi.Int>)>()
external int FPDF_GetFileVersion(
  FPDF_DOCUMENT doc,
...
external int FPDF_GetLastError();
...
external int FPDF_DocumentHasValidCrossReferenceTable(FPDF_DOCUMENT document);
...
@ffi.Native<ffi.Int Function(FPDF_DOCUMENT)>()
external int FPDF_GetPageCount(FPDF_DOCUMENT document);
...
external void FPDF_ClosePage(FPDF_PAGE page);
...
/// Return value:
/// None.
@ffi.Native<ffi.Void Function(FPDF_DOCUMENT)>()
external void FPDF_CloseDocument(FPDF_DOCUMENT document);
...
>()
external int FPDF_DeviceToPage(
  FPDF_PAGE page,
  int start_x,
  int start_y,
  int size_x,
...
>()
external int FPDFBitmap_FillRect(
  FPDF_BITMAP bitmap,
  int left,
  int top,
  int width,
...
@ffi.Native<FPDF_PAGERANGE Function(FPDF_DOCUMENT)>()
external FPDF_PAGERANGE FPDF_VIEWERREF_GetPrintPageRange(
  FPDF_DOCUMENT document,
);
...
@ffi.Native<ffi.Size Function(FPDF_PAGERANGE)>()
external int FPDF_VIEWERREF_GetPrintPageRangeCount(FPDF_PAGERANGE pagerange);
...
@ffi.Native<ffi.UnsignedInt Function(FPDF_DOCUMENT)>(
  symbol: 'FPDF_VIEWERREF_GetDuplex',
)
external int _FPDF_VIEWERREF_GetDuplex(FPDF_DOCUMENT document);

_FPDF_DUPLEXTYPE_ FPDF_VIEWERREF_GetDuplex(FPDF_DOCUMENT document) =>
    _FPDF_DUPLEXTYPE_.fromValue(_FPDF_VIEWERREF_GetDuplex(document));
...
@ffi.Native<FPDF_DWORD Function(FPDF_DOCUMENT)>()
external int FPDF_CountNamedDests(FPDF_DOCUMENT document);
...
@ffi.Native<FPDF_DEST Function(FPDF_DOCUMENT, FPDF_BYTESTRING)>()
external FPDF_DEST FPDF_GetNamedDestByName(
  FPDF_DOCUMENT document,
...
@ffi.Native<ffi.Int Function(FPDF_DOCUMENT)>()
external int FPDF_GetXFAPacketCount(FPDF_DOCUMENT document);
...
/// automatically freed.
@ffi.Native<ffi.Void Function(FPDF_PAGE, FPDF_PAGEOBJECT)>()
external void FPDFPage_InsertObject(
  FPDF_PAGE page,
...
@ffi.Native<FPDF_BOOL Function(FPDF_PAGE, FPDF_PAGEOBJECT)>()
external int FPDFPage_RemoveObject(FPDF_PAGE page, FPDF_PAGEOBJECT page_object);
...
external int FPDFPage_HasTransparency(FPDF_PAGE page);
...
external int FPDFPageObj_HasTransparency(FPDF_PAGEOBJECT page_object);
...
external int FPDFPageObj_GetType(FPDF_PAGEOBJECT page_object);
...
/// Returns TRUE on success.
@ffi.Native<FPDF_BOOL Function(FPDF_PAGEOBJECT, ffi.Pointer<FS_MATRIX>)>()
external int FPDFPageObj_GetMatrix(
  FPDF_PAGEOBJECT page_object,
  ffi.Pointer<FS_MATRIX> matrix,
);
...
>()
external void FPDFPage_TransformAnnots(
  FPDF_PAGE page,
  double a,
  double b,
  double c,
...
/// unloading the page.
@ffi.Native<FPDF_PAGEOBJECTMARK Function(FPDF_PAGEOBJECT, ffi.UnsignedLong)>()
external FPDF_PAGEOBJECTMARK FPDFPageObj_GetMark(
  FPDF_PAGEOBJECT page_object,
  int index,
);
...
external int FPDFPageObj_RemoveMark(
  FPDF_PAGEOBJECT page_object,
...
@ffi.Native<FPDF_OBJECT_TYPE Function(FPDF_PAGEOBJECTMARK, FPDF_BYTESTRING)>()
external int FPDFPageObjMark_GetParamValueType(
  FPDF_PAGEOBJECTMARK mark,
  FPDF_BYTESTRING key,
);
...
>()
external int FPDFPageObjMark_GetParamStringValue(
  FPDF_PAGEOBJECTMARK mark,
  FPDF_BYTESTRING key,
  ffi.Pointer<FPDF_WCHAR> buffer,
  int buflen,
...
>()
external int FPDFPageObjMark_SetIntParam(
  FPDF_DOCUMENT document,
  FPDF_PAGEOBJECT page_object,
  FPDF_PAGEOBJECTMARK mark,
  FPDF_BYTESTRING key,
...
>()
external int FPDFPageObjMark_SetFloatParam(
  FPDF_DOCUMENT document,
  FPDF_PAGEOBJECT page_object,
  FPDF_PAGEOBJECTMARK mark,
  FPDF_BYTESTRING key,
...
>()
external int FPDFPageObjMark_SetStringParam(
  FPDF_DOCUMENT document,
  FPDF_PAGEOBJECT page_object,
  FPDF_PAGEOBJECTMARK mark,
  FPDF_BYTESTRING key,
...
/// Returns TRUE if the operation succeeded, FALSE otherwise.
@ffi.Native<
  FPDF_BOOL Function(FPDF_PAGEOBJECT, FPDF_PAGEOBJECTMARK, FPDF_BYTESTRING)
>()
external int FPDFPageObjMark_RemoveParam(
  FPDF_PAGEOBJECT page_object,
  FPDF_PAGEOBJECTMARK mark,
  FPDF_BYTESTRING key,
);
...
>()
external int FPDFImageObj_LoadJpegFile(
...
>()
external int FPDFImageObj_GetImageDataRaw(
  FPDF_PAGEOBJECT image_object,
  ffi.Pointer<ffi.Void> buffer,
  int buflen,
);
...
@ffi.Native<ffi.Int Function(FPDF_PAGEOBJECT)>()
external int FPDFImageObj_GetImageFilterCount(FPDF_PAGEOBJECT image_object);
...
>()
external int FPDFImageObj_GetImageFilter(
  FPDF_PAGEOBJECT image_object,
  int index,
  ffi.Pointer<ffi.Void> buffer,
  int buflen,
...
>()
external int FPDFImageObj_GetIccProfileDataDecoded(
  FPDF_PAGEOBJECT image_object,
  FPDF_PAGE page,
...
@ffi.Native<FPDF_PAGEOBJECT Function(ffi.Float, ffi.Float)>()
external FPDF_PAGEOBJECT FPDFPageObj_CreateNewPath(double x, double y);
...
>()
external int FPDFPageObj_SetStrokeColor(
  FPDF_PAGEOBJECT page_object,
  int R,
  int G,
  int B,
...
>()
external int FPDFPageObj_GetStrokeColor(
  FPDF_PAGEOBJECT page_object,
  ffi.Pointer<ffi.UnsignedInt> R,
  ffi.Pointer<ffi.UnsignedInt> G,
  ffi.Pointer<ffi.UnsignedInt> B,
...
/// FPDF_LINEJOIN_BEVEL
@ffi.Native<ffi.Int Function(FPDF_PAGEOBJECT)>()
external int FPDFPageObj_GetLineJoin(FPDF_PAGEOBJECT page_object);
...
external int FPDFPageObj_SetLineJoin(
  FPDF_PAGEOBJECT page_object,
  int line_join,
);
...
>()
external int FPDFPageObj_SetFillColor(
  FPDF_PAGEOBJECT page_object,
  int R,
  int G,
  int B,
...
>()
external int FPDFPageObj_GetFillColor(
  FPDF_PAGEOBJECT page_object,
  ffi.Pointer<ffi.UnsignedInt> R,
  ffi.Pointer<ffi.UnsignedInt> G,
  ffi.Pointer<ffi.UnsignedInt> B,
...
@ffi.Native<ffi.Int Function(FPDF_PATHSEGMENT)>()
external int FPDFPathSegment_GetType(FPDF_PATHSEGMENT segment);
...
@ffi.Native<FPDF_BOOL Function(FPDF_PATHSEGMENT)>()
external int FPDFPathSegment_GetClose(FPDF_PATHSEGMENT segment);
...
>()
external FPDF_FONT FPDFText_LoadCidType2Font(
  FPDF_DOCUMENT document,
...
@ffi.Native<ffi.Int Function(FPDF_PAGEOBJECT)>(
  symbol: 'FPDFTextObj_GetTextRenderMode',
)
external int _FPDFTextObj_GetTextRenderMode(FPDF_PAGEOBJECT text);

FPDF_TEXT_RENDERMODE FPDFTextObj_GetTextRenderMode(FPDF_PAGEOBJECT text) =>
    FPDF_TEXT_RENDERMODE.fromValue(_FPDFTextObj_GetTextRenderMode(text));
...
/// Returns TRUE on success.
@ffi.Native<FPDF_BOOL Function(FPDF_PAGEOBJECT, ffi.Int)>(
  symbol: 'FPDFTextObj_SetTextRenderMode',
)
external int _FPDFTextObj_SetTextRenderMode(
  FPDF_PAGEOBJECT text,
  int render_mode,
);
...
) => _FPDFTextObj_SetTextRenderMode(text, render_mode.value);
...
/// Returns the bitmap or NULL on failure.
@ffi.Native<
  FPDF_BITMAP Function(FPDF_DOCUMENT, FPDF_PAGE, FPDF_PAGEOBJECT, ffi.Float)
>()
external FPDF_BITMAP FPDFTextObj_GetRenderedBitmap(
  FPDF_DOCUMENT document,
  FPDF_PAGE page,
  FPDF_PAGEOBJECT text_object,
  double scale,
...
external int FPDFFont_GetBaseFontName(
  FPDF_FONT font,
  ffi.Pointer<ffi.Char> buffer,
  int length,
);
...
@ffi.Native<FPDF_BOOL Function(FPDF_FONT, ffi.Float, ffi.Pointer<ffi.Float>)>()
external int FPDFFont_GetAscent(
  FPDF_FONT font,
  double font_size,
...
@ffi.Native<FPDF_BOOL Function(FPDF_FONT, ffi.Float, ffi.Pointer<ffi.Float>)>()
external int FPDFFont_GetDescent(
  FPDF_FONT font,
  double font_size,
...
///
/// Returns the handle to the segment, or NULL on faiure.
@ffi.Native<FPDF_PATHSEGMENT Function(FPDF_GLYPHPATH, ffi.Int)>()
external FPDF_PATHSEGMENT FPDFGlyphPath_GetGlyphPathSegment(
...
@ffi.Native<ffi.Int Function(FPDF_PAGEOBJECT)>()
external int FPDFFormObj_CountObjects(FPDF_PAGEOBJECT form_object);
...
@ffi.Native<FPDF_BOOL Function(FPDF_PAGEOBJECT, FPDF_PAGEOBJECT)>()
external int FPDFFormObj_RemoveObject(
  FPDF_PAGEOBJECT form_object,
  FPDF_PAGEOBJECT page_object,
);
...
>()
external FPDF_FORMHANDLE FPDFDOC_InitFormFillEnvironment(
  FPDF_DOCUMENT document,
...
/// Return Value:
/// None.
@ffi.Native<ffi.Void Function(FPDF_PAGE, FPDF_FORMHANDLE)>()
external void FORM_OnAfterLoadPage(FPDF_PAGE page, FPDF_FORMHANDLE hHandle);
...
/// None.
@ffi.Native<ffi.Void Function(FPDF_PAGE, FPDF_FORMHANDLE)>()
external void FORM_OnBeforeClosePage(FPDF_PAGE page, FPDF_FORMHANDLE hHandle);
...
>()
external int FORM_OnLButtonDown(
  FPDF_FORMHANDLE hHandle,
  FPDF_PAGE page,
  int modifier,
  double page_x,
...
>()
external int FORM_OnRButtonDown(
  FPDF_FORMHANDLE hHandle,
  FPDF_PAGE page,
  int modifier,
  double page_x,
...
>()
external int FORM_OnLButtonDoubleClick(
  FPDF_FORMHANDLE hHandle,
  FPDF_PAGE page,
  int modifier,
  double page_x,
...
/// Return Value:
/// None.
@ffi.Native<ffi.Void Function(FPDF_FORMHANDLE, FPDF_PAGE, FPDF_WIDESTRING)>()
external void FORM_ReplaceAndKeepSelection(
  FPDF_FORMHANDLE hHandle,
  FPDF_PAGE page,
...
/// None.
@ffi.Native<ffi.Void Function(FPDF_FORMHANDLE, FPDF_PAGE, FPDF_WIDESTRING)>()
external void FORM_ReplaceSelection(
  FPDF_FORMHANDLE hHandle,
  FPDF_PAGE page,
  FPDF_WIDESTRING wsText,
);
...
@ffi.Native<FPDF_BOOL Function(FPDF_FORMHANDLE, FPDF_PAGE)>()
external int FORM_CanUndo(FPDF_FORMHANDLE hHandle, FPDF_PAGE page);
...
@ffi.Native<FPDF_BOOL Function(FPDF_FORMHANDLE, FPDF_PAGE)>()
external int FORM_CanRedo(FPDF_FORMHANDLE hHandle, FPDF_PAGE page);
...
external int FORM_SetFocusedAnnot(
  FPDF_FORMHANDLE handle,
...
/// if necessary.
@ffi.Native<ffi.Void Function(FPDF_FORMHANDLE, ffi.Int, ffi.UnsignedLong)>()
external void FPDF_SetFormFieldHighlightColor(
  FPDF_FORMHANDLE hHandle,
  int fieldType,
  int color,
);
...
@ffi.Native<ffi.Int Function(FPDF_DOCUMENT)>()
external int FPDF_GetFormType(FPDF_DOCUMENT document);
...
@ffi.Native<
  FPDF_BOOL Function(FPDF_FORMHANDLE, FPDF_PAGE, ffi.Int, FPDF_BOOL)
>()
external int FORM_SetIndexSelected(
  FPDF_FORMHANDLE hHandle,
  FPDF_PAGE page,
  int index,
  int selected,
...
/// Not currently supported for XFA forms - will return false.
@ffi.Native<FPDF_BOOL Function(FPDF_FORMHANDLE, FPDF_PAGE, ffi.Int)>()
external int FORM_IsIndexSelected(
  FPDF_FORMHANDLE hHandle,
  FPDF_PAGE page,
  int index,
);
...
@ffi.Native<FPDF_BOOL Function(FPDF_ANNOTATION_SUBTYPE)>()
external int FPDFAnnot_IsSupportedSubtype(int subtype);
...
@ffi.Native<FPDF_ANNOTATION_SUBTYPE Function(FPDF_ANNOTATION)>()
external int FPDFAnnot_GetSubtype(FPDF_ANNOTATION annot);
...
/// Returns true if this subtype supported.
@ffi.Native<FPDF_BOOL Function(FPDF_ANNOTATION_SUBTYPE)>()
external int FPDFAnnot_IsObjectSupportedSubtype(int subtype);
...
external int FPDFAnnot_RemoveInkList(FPDF_ANNOTATION annot);
...
>(symbol: 'FPDFAnnot_SetColor')
external int _FPDFAnnot_SetColor(
  FPDF_ANNOTATION annot,
  int type,
  int R,
  int G,
...
DartFPDF_BOOL FPDFAnnot_SetColor(
  ...
  int B,
  int A,
) => _FPDFAnnot_SetColor(annot, type.value, R, G, B, A);
...
>(symbol: 'FPDFAnnot_GetColor')
external int _FPDFAnnot_GetColor(
  FPDF_ANNOTATION annot,
  int type,
  ffi.Pointer<ffi.UnsignedInt> R,
  ffi.Pointer<ffi.UnsignedInt> G,
...
DartFPDF_BOOL FPDFAnnot_GetColor(
  ...
  ffi.Pointer<ffi.UnsignedInt> B,
  ffi.Pointer<ffi.UnsignedInt> A,
) => _FPDFAnnot_GetColor(annot, type.value, R, G, B, A);
...
///
/// Returns true if successful.
@ffi.Native<FPDF_BOOL Function(FPDF_ANNOTATION, ffi.Pointer<FS_QUADPOINTSF>)>()
external int FPDFAnnot_AppendAttachmentPoints(
  FPDF_ANNOTATION annot,
  ffi.Pointer<FS_QUADPOINTSF> quad_points,
);
...
>()
external int FPDFAnnot_GetBorder(
  FPDF_ANNOTATION annot,
...
>()
external int FPDFAnnot_GetFormAdditionalActionJavaScript(
  FPDF_FORMHANDLE hHandle,
  FPDF_ANNOTATION annot,
  int event,
  ffi.Pointer<FPDF_WCHAR> buffer,
...
///
/// Returns the type of the dictionary value.
@ffi.Native<FPDF_OBJECT_TYPE Function(FPDF_ANNOTATION, FPDF_BYTESTRING)>()
external int FPDFAnnot_GetValueType(FPDF_ANNOTATION annot, FPDF_BYTESTRING key);
...
@ffi.Native<ffi.Int Function(FPDF_ANNOTATION)>()
external int FPDFAnnot_GetFlags(FPDF_ANNOTATION annot);
...
/// Returns true if successful.
@ffi.Native<FPDF_BOOL Function(FPDF_ANNOTATION, ffi.Int)>()
external int FPDFAnnot_SetFlags(FPDF_ANNOTATION annot, int flags);
...
external int FPDFAnnot_GetFormFieldFlags(
  FPDF_FORMHANDLE handle,
  FPDF_ANNOTATION annot,
);
...
external int FPDFAnnot_SetFormFieldFlags(
  FPDF_FORMHANDLE handle,
  FPDF_ANNOTATION annot,
  int flags,
);
...
>()
external int FPDFAnnot_GetFormFieldName(
  FPDF_FORMHANDLE hHandle,
  FPDF_ANNOTATION annot,
  ffi.Pointer<FPDF_WCHAR> buffer,
  int buflen,
...
@ffi.Native<ffi.Int Function(FPDF_FORMHANDLE, FPDF_ANNOTATION)>()
external int FPDFAnnot_GetFormFieldType(
  FPDF_FORMHANDLE hHandle,
  FPDF_ANNOTATION annot,
);
...
>()
external int FPDFAnnot_GetFormFieldValue(
  FPDF_FORMHANDLE hHandle,
  FPDF_ANNOTATION annot,
  ffi.Pointer<FPDF_WCHAR> buffer,
  int buflen,
...
>()
external int FPDFAnnot_GetOptionLabel(
  FPDF_FORMHANDLE hHandle,
  FPDF_ANNOTATION annot,
  int index,
  ffi.Pointer<FPDF_WCHAR> buffer,
...
>()
external int FPDFAnnot_SetFontColor(
  FPDF_FORMHANDLE handle,
  FPDF_ANNOTATION annot,
  int R,
  int G,
...
>()
external int FPDFAnnot_GetFontColor(
  FPDF_FORMHANDLE hHandle,
  FPDF_ANNOTATION annot,
  ffi.Pointer<ffi.UnsignedInt> R,
  ffi.Pointer<ffi.UnsignedInt> G,
...
>()
external int FPDFAnnot_SetFocusableSubtypes(
  FPDF_FORMHANDLE hHandle,
...
@ffi.Native<ffi.Int Function(FPDF_FORMHANDLE)>()
external int FPDFAnnot_GetFocusableSubtypesCount(FPDF_FORMHANDLE hHandle);
...
>()
external int FPDFAnnot_GetFocusableSubtypes(
  FPDF_FORMHANDLE hHandle,
  ffi.Pointer<FPDF_ANNOTATION_SUBTYPE> subtypes,
  int count,
);
...
@ffi.Native<ffi.Int Function(FPDF_FORMHANDLE, FPDF_ANNOTATION)>()
external int FPDFAnnot_GetFormControlIndex(
  FPDF_FORMHANDLE hHandle,
  FPDF_ANNOTATION annot,
);
...
>()
external int FPDFAnnot_GetFormFieldExportValue(
  FPDF_FORMHANDLE hHandle,
  FPDF_ANNOTATION annot,
  ffi.Pointer<FPDF_WCHAR> buffer,
  int buflen,
...
///
/// Returns TRUE on success.
@ffi.Native<FPDF_BOOL Function(FPDF_DOCUMENT, FPDF_BYTESTRING)>()
...
@ffi.Native<ffi.Int Function(FPDF_BOOKMARK)>()
external int FPDFBookmark_GetCount(FPDF_BOOKMARK bookmark);
...
/// PDFACTION_URI
/// PDFACTION_LAUNCH
@ffi.Native<ffi.UnsignedLong Function(FPDF_ACTION)>()
external int FPDFAction_GetType(FPDF_ACTION action);
...
>()
external int FPDFAction_GetURIPath(
  FPDF_DOCUMENT document,
  FPDF_ACTION action,
  ffi.Pointer<ffi.Void> buffer,
  int buflen,
...
/// valid.
@ffi.Native<FPDF_ACTION Function(FPDF_LINK)>()
external FPDF_ACTION FPDFLink_GetAction(FPDF_LINK link);
...
/// valid.
@ffi.Native<FPDF_ACTION Function(FPDF_PAGE, ffi.Int)>()
external FPDF_ACTION FPDF_GetPageAAction(FPDF_PAGE page, int aa_type);
...
>(symbol: 'FPDF_GetFileIdentifier')
external int _FPDF_GetFileIdentifier(
  FPDF_DOCUMENT document,
  int id_type,
  ffi.Pointer<ffi.Void> buffer,
  int buflen,
...
int FPDF_GetFileIdentifier(
  ...
  ffi.Pointer<ffi.Void> buffer,
  int buflen,
) => _FPDF_GetFileIdentifier(document, id_type.value, buffer, buflen);
...
external int time(ffi.Pointer<time_t> __timer);

@ffi.Native<ffi.Double Function(time_t, time_t)>()
external double difftime(int __time1, int __time0);

@ffi.Native<time_t Function(ffi.Pointer<tm>)>()
external int mktime(ffi.Pointer<tm> __tp);
...
external ffi.Pointer<tm> gmtime(ffi.Pointer<time_t> __timer);

@ffi.Native<ffi.Pointer<tm> Function(ffi.Pointer<time_t>)>()
external ffi.Pointer<tm> localtime(ffi.Pointer<time_t> __timer);
...
external ffi.Pointer<ffi.Char> asctime(ffi.Pointer<tm> __tp);

@ffi.Native<ffi.Pointer<ffi.Char> Function(ffi.Pointer<time_t>)>()
external ffi.Pointer<ffi.Char> ctime(ffi.Pointer<time_t> __timer);
...
@ffi.Array.multi([2])
@ffi.Native<ffi.Array<ffi.Pointer<ffi.Char>>>()
external ffi.Array<ffi.Pointer<ffi.Char>> __tzname;

@ffi.Native<ffi.Int>()
external int __daylight;

@ffi.Native<ffi.Long>()
external int __timezone;

@ffi.Array.multi([2])
@ffi.Native<ffi.Array<ffi.Pointer<ffi.Char>>>()
external ffi.Array<ffi.Pointer<ffi.Char>> tzname;
...
@ffi.Native<time_t Function(ffi.Pointer<tm>)>()
external int timegm(ffi.Pointer<tm> __tp);

@ffi.Native<time_t Function(ffi.Pointer<tm>)>()
external int timelocal(ffi.Pointer<tm> __tp);

@ffi.Native<ffi.Int Function(ffi.Int)>()
external int dysize(int __year);
...
external int clock_getres(int __clock_id, ffi.Pointer<timespec> __res);

@ffi.Native<ffi.Int Function(clockid_t, ffi.Pointer<timespec>)>()
external int clock_gettime(int __clock_id, ffi.Pointer<timespec> __tp);

@ffi.Native<ffi.Int Function(clockid_t, ffi.Pointer<timespec>)>()
external int clock_settime(int __clock_id, ffi.Pointer<timespec> __tp);
...
external int clock_getcpuclockid(int __pid, ffi.Pointer<clockid_t> __clock_id);
...
external int timer_delete(timer_t __timerid);
...
external int timer_gettime(timer_t __timerid, ffi.Pointer<itimerspec> __value);

@ffi.Native<ffi.Int Function(timer_t)>()
external int timer_getoverrun(timer_t __timerid);

@ffi.Native<ffi.Int Function(ffi.Pointer<timespec>, ffi.Int)>()
external int timespec_get(ffi.Pointer<timespec> __ts, int __base);
...
final class _IPDF_JsPlatform extends ffi.Struct {
  ...
  external ffi.Pointer<
    ffi.NativeFunction<
      ffi.Void Function(ffi.Pointer<_IPDF_JsPlatform> pThis, ffi.Int nType)
    >
  >
  app_beep;
  ...
  external ffi.Pointer<
    ffi.NativeFunction<
      ffi.Void Function(ffi.Pointer<_IPDF_JsPlatform> pThis, ffi.Int nPageNum)
    >
  >
  Doc_gotoPage;
...
final class _FPDF_FORMFILLINFO extends ffi.Struct {
  ...
  /// None
  external ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<_FPDF_FORMFILLINFO> pThis)>
  >
  Release;
  ...
  external ffi.Pointer<
    ffi.NativeFunction<
      ffi.Void Function(ffi.Pointer<_FPDF_FORMFILLINFO> pThis, ffi.Int nTimerID)
    >
  >
  FFI_KillTimer;
  ...
  external ffi.Pointer<
    ffi.NativeFunction<
      ffi.Int Function(ffi.Pointer<_FPDF_FORMFILLINFO> pThis, FPDF_PAGE page)
    >
  >
  FFI_GetRotation;
  ...
  external ffi.Pointer<
    ffi.NativeFunction<
      FPDF_BOOL Function(
        ...
        ffi.Pointer<FPDF_BSTR> response,
      )
    >
  >
  FFI_PostRequestURL;
...
final class FPDF_FILEWRITE_ extends ffi.Struct {
  ...
  external ffi.Pointer<
    ffi.NativeFunction<
      ffi.Int Function(
        ffi.Pointer<FPDF_FILEWRITE_> pThis,
...
final class _UNSUPPORT_INFO extends ffi.Struct {
  ...
  external ffi.Pointer<
    ffi.NativeFunction<
      ffi.Void Function(ffi.Pointer<_UNSUPPORT_INFO> pThis, ffi.Int nType)
    >
  >
