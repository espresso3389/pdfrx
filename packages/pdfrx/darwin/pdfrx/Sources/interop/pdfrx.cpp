...
#define KEEP_FUNC(func) reinterpret_cast<const void *>(#func), reinterpret_cast<const void *>(func)
  ...
  static void const * const bindings[] = {
      ...
      KEEP_FUNC(FPDF_GetSignatureCount),
      KEEP_FUNC(FPDF_GetSignatureObject),
      KEEP_FUNC(FPDFSignatureObj_GetContents),
      KEEP_FUNC(FPDFSignatureObj_GetByteRange),
      KEEP_FUNC(FPDFSignatureObj_GetSubFilter),
      KEEP_FUNC(FPDFSignatureObj_GetReason),
      KEEP_FUNC(FPDFSignatureObj_GetTime),
      KEEP_FUNC(FPDFSignatureObj_GetDocMDPPermission),
      ...
      KEEP_FUNC(FPDFDoc_GetJavaScriptActionCount),
      KEEP_FUNC(FPDFDoc_GetJavaScriptAction),
      KEEP_FUNC(FPDFDoc_CloseJavaScriptAction),
      KEEP_FUNC(FPDFJavaScriptAction_GetName),
      KEEP_FUNC(FPDFJavaScriptAction_GetScript),
      ...
      KEEP_FUNC(FPDFText_GetCharIndexFromTextIndex),
      KEEP_FUNC(FPDFText_GetTextIndexFromCharIndex),
      KEEP_FUNC(FPDF_RenderPageBitmapWithColorScheme_Start),
      KEEP_FUNC(FPDF_RenderPageBitmap_Start),
      KEEP_FUNC(FPDF_RenderPage_Continue),
      KEEP_FUNC(FPDF_RenderPage_Close),
      ...
      //KEEP_FUNC(FPDFPageObjMark_GetParamFloatValue),
      ...
      //KEEP_FUNC(FPDFPageObjMark_SetFloatParam),
      ...
      KEEP_FUNC(FPDFDoc_GetAttachmentCount),
      KEEP_FUNC(FPDFDoc_AddAttachment),
      KEEP_FUNC(FPDFDoc_GetAttachment),
      KEEP_FUNC(FPDFDoc_DeleteAttachment),
      KEEP_FUNC(FPDFAttachment_GetName),
      KEEP_FUNC(FPDFAttachment_HasKey),
      KEEP_FUNC(FPDFAttachment_GetValueType),
      KEEP_FUNC(FPDFAttachment_SetStringValue),
      KEEP_FUNC(FPDFAttachment_GetStringValue),
      KEEP_FUNC(FPDFAttachment_SetFile),
      KEEP_FUNC(FPDFAttachment_GetFile),
      KEEP_FUNC(FPDFAttachment_GetSubtype),
      ...
      KEEP_FUNC(FPDFCatalog_IsTagged),
      KEEP_FUNC(FPDFCatalog_SetLanguage),
      ...
      KEEP_FUNC(FPDF_StructTree_GetForPage),
      KEEP_FUNC(FPDF_StructTree_Close),
      KEEP_FUNC(FPDF_StructTree_CountChildren),
      KEEP_FUNC(FPDF_StructTree_GetChildAtIndex),
      KEEP_FUNC(FPDF_StructElement_GetAltText),
      KEEP_FUNC(FPDF_StructElement_GetActualText),
      KEEP_FUNC(FPDF_StructElement_GetID),
      KEEP_FUNC(FPDF_StructElement_GetLang),
      KEEP_FUNC(FPDF_StructElement_GetStringAttribute),
      KEEP_FUNC(FPDF_StructElement_GetMarkedContentID),
      KEEP_FUNC(FPDF_StructElement_GetType),
      KEEP_FUNC(FPDF_StructElement_GetObjType),
      KEEP_FUNC(FPDF_StructElement_GetTitle),
      KEEP_FUNC(FPDF_StructElement_CountChildren),
      KEEP_FUNC(FPDF_StructElement_GetChildAtIndex),
      KEEP_FUNC(FPDF_StructElement_GetChildMarkedContentID),
      KEEP_FUNC(FPDF_StructElement_GetParent),
      KEEP_FUNC(FPDF_StructElement_GetAttributeCount),
      KEEP_FUNC(FPDF_StructElement_GetAttributeAtIndex),
      KEEP_FUNC(FPDF_StructElement_Attr_GetCount),
      KEEP_FUNC(FPDF_StructElement_Attr_GetName),
      KEEP_FUNC(FPDF_StructElement_Attr_GetValue),
      KEEP_FUNC(FPDF_StructElement_Attr_GetType),
      KEEP_FUNC(FPDF_StructElement_Attr_GetBooleanValue),
      KEEP_FUNC(FPDF_StructElement_Attr_GetNumberValue),
      KEEP_FUNC(FPDF_StructElement_Attr_GetStringValue),
      KEEP_FUNC(FPDF_StructElement_Attr_GetBlobValue),
      KEEP_FUNC(FPDF_StructElement_Attr_CountChildren),
      KEEP_FUNC(FPDF_StructElement_Attr_GetChildAtIndex),
      KEEP_FUNC(FPDF_StructElement_GetMarkedContentIdCount),
      KEEP_FUNC(FPDF_StructElement_GetMarkedContentIdAtIndex),
      KEEP_FUNC(FPDFAvail_Create),
      KEEP_FUNC(FPDFAvail_Destroy),
      KEEP_FUNC(FPDFAvail_IsDocAvail),
      KEEP_FUNC(FPDFAvail_GetDocument),
      KEEP_FUNC(FPDFAvail_GetFirstPageNum),
      KEEP_FUNC(FPDFAvail_IsPageAvail),
      KEEP_FUNC(FPDFAvail_IsFormAvail),
      KEEP_FUNC(FPDFAvail_IsLinearized),
      KEEP_FUNC(FSDK_SetUnSpObjProcessHandler),
      KEEP_FUNC(FSDK_SetTimeFunction),
      KEEP_FUNC(FSDK_SetLocaltimeFunction),
      KEEP_FUNC(FPDFDoc_GetPageMode),
      KEEP_FUNC(FPDFPage_SetMediaBox),
      KEEP_FUNC(FPDFPage_SetCropBox),
      KEEP_FUNC(FPDFPage_SetBleedBox),
      KEEP_FUNC(FPDFPage_SetTrimBox),
      KEEP_FUNC(FPDFPage_SetArtBox),
      KEEP_FUNC(FPDFPage_GetMediaBox),
      KEEP_FUNC(FPDFPage_GetCropBox),
      KEEP_FUNC(FPDFPage_GetBleedBox),
      KEEP_FUNC(FPDFPage_GetTrimBox),
      KEEP_FUNC(FPDFPage_GetArtBox),
      KEEP_FUNC(FPDFPage_TransFormWithClip),
      KEEP_FUNC(FPDFPageObj_TransformClipPath),
      KEEP_FUNC(FPDFPageObj_GetClipPath),
      KEEP_FUNC(FPDFClipPath_CountPaths),
      KEEP_FUNC(FPDFClipPath_CountPathSegments),
      KEEP_FUNC(FPDFClipPath_GetPathSegment),
      KEEP_FUNC(FPDF_CreateClipPath),
      KEEP_FUNC(FPDF_DestroyClipPath),
      KEEP_FUNC(FPDFPage_InsertClipPath),
      KEEP_FUNC(FPDFPage_Flatten),
      KEEP_FUNC(FPDFPage_GetDecodedThumbnailData),
      KEEP_FUNC(FPDFPage_GetRawThumbnailData),
      KEEP_FUNC(FPDFPage_GetThumbnailAsBitmap),
