...
Pod::Spec.new do |s|
  ...
  s.ios.private_header_files = 'pdfium/ios/pdfium.xcframework/ios-arm64/Headers/*.h'
  s.ios.vendored_frameworks = 'pdfium/ios/pdfium.xcframework'
  ...
  s.osx.private_header_files = 'pdfium/macos/pdfium.xcframework/macos-arm64_x86_64/Headers/*.h'
  s.osx.vendored_frameworks = 'pdfium/macos/pdfium.xcframework'
