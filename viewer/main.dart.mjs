...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      CJ: x0 => x0.pop(),
      CK: x0 => { globalThis.pdfiumWasmWorkerUrl = x0 },
      CL: x0 => x0.message,
      ...
      IK: (x0,x1) => x0.registerCallback(x1),
      IL: x0 => x0.length,
      ...
      OK: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      OL: x0 => x0.getReader(),
      ...
      TH: x0 => x0.first(),
      TI: x0 => x0.button,
      TJ: (x0,x1,x2,x3,x4) => ({type: x0,data: x1,premultiplyAlpha: x2,colorSpaceConversion: x3,preferAnimation: x4}),
      TK: x0 => x0.vendor,
      ...
      UH: x0 => x0.next(),
      UI: x0 => x0.classList,
      UJ: x0 => new window.ImageDecoder(x0),
      UK: x0 => x0.abort(),
      UL: x0 => x0.assetBase,
      V: (constructor, args) => {
      ...
      WJ: x0 => x0.repetitionCount,
      WK: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      ...
      XI: x0 => x0.style,
      XJ: x0 => x0.frameCount,
      XK: (x0,x1) => globalThis.fetch(x0,x1),
      Y: (o0, o1) => [o0, o1],
      ...
      ZI: x0 => x0.head,
      ZJ: x0 => x0.completed,
      ZK: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1,x2) { return wasmFunction(f,arguments.length,x0,x1,x2) }),
      ...
      dJ: (x0,x1) => ({frameIndex: x0,completeFramesOnly: x1}),
      dK: x0 => x0.url,
      e: () => globalThis,
      eB: o => {
        if (o === null || o === undefined) return 0;
