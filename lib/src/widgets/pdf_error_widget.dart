  ...
  return Container(
    ...
    child: Center(
      child: Column(
        ...
        children: [
          _GestureRecognizerDisposer(
            builder: (context, markForDispose) {
...
typedef _GestureRecognizerDisposerBuilderFunction =
    Widget Function(BuildContext context, _GestureRecognizerDisposerFunction markForDispose);
